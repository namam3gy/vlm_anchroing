...
9. **×12.7 ratio paired-bootstrap CI (§4.5 hardening).** Qwen3-VL Instruct vs Thinking correct-base df ratio의 paired-bootstrap CI 산출. 동일 stratified-sids 위 paired resample × ratio 재계산 (B=10,000), percentile CI. ~2 H100-hour. Round-1 MAJOR-6 / round-4 MAJ-7 요구사항. 본 결과 후 §4.5 / §8.2 의 "×12.7" 표현은 정량 CI로 대체된다.
