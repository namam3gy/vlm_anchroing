...
| LEACE closed-form (rank-1) | ❌ Cross-dataset inconsistent (TallyQA Δdf @α=1.0 = +0.6 pp [CI border 0] *borderline backfire*; ChartQA Δdf @α=0.5 = −2.7 pp [−5.4, −0.5] mild mit; 나머지 null) | 불변 | b-arm em +0.5 ~ +2.7 pp on 5/5 (anchor-indep) | single-direction redundancy |
